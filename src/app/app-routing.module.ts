...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: ':lang/profile-change',
        loadChildren: () =>
          import('./views/profile-change/profile-change.module').then((m) => m.ProfileChangeModule),
      },
      {
      ...
      {
        path: ':lang/gold-member',
        loadChildren: () =>
          import('./views/gold-member/gold-member.module').then((m) => m.GoldMemberModule),
      },
      {
        path: 'user-profile-detail',
        loadChildren: () =>
          import('./views/user-profile-detail/user-profile-detail.module').then(
            (m) => m.UserProfileDetailModule
          ),
      },
      {
      ...
      },
      {
        path: 'message-inbox',
        loadChildren: () =>
          import('./views/message-inbox/message-inbox.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./views/blog/blog-detail/blog-detail.module').then(
